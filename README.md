...
MOSFET(NMOS,PMOS) Construction & Its working was discussed. Simple mathematical models of MOSFET were Simulated using SPICE. Emphasis was made on how to create Spice netlist, Spice commands & Technology parameters of MOSFET.
